...
* ```
*/
var starter = angular.module('starter', ['ionic', 'ngCordova', 'angular-preload-image', 'ionic-ratings', 'ngLocalize', 'ngLocalize.InstalledLanguages', 'ionic.service.core', 'ngStorage', 'ngMessages', 'shop.module', 'offers.module', 'cart.module', 'info.module', 'payments.module', 'auth.module'])
    .run(function ($ionicPlatform, $ionicPopup, $ionicLoading, $ionicNavBarDelegate, $ionicScrollDelegate, $rootScope, $timeout, $state, $localStorage, notificationService, updateService, analyticsService, intercomService) {
