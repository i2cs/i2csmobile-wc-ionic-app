angular.module('starter')
    ...
    .constant('FORGOT_LINK', 'https://saasthara.com/i2cs/shops/woocommerce/my-account/lost-password/')
    .constant('EMAIL', 'info@9aydaly.com')
    .constant('PHONE', '+96599368686')
    ...
    .constant('MAIN_OFFERS_BANNER_ID', 266)
    .constant('OFFERS_PAGE_BANNER_ID', 267)
    .constant('INTERCOM_INTEGRATION', false) // please check www/app/common/services/intercom.service.js
    .constant('ONESIGNAL_APP_ID', "9302072d-783a-41f4-b3dc-80359f64ef96") // get OneSignal app id from https://onesignal.com
