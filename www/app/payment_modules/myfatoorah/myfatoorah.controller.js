...
angular
    ...
    .controller('PaymentmyfatoorahCtrl', function ($scope, $rootScope, $stateParams, $state, $ionicLoading, CartService, PaymentmyfatoorahService) {
        ...
        $scope.pay = function () {
            ...
            CartService.AddOrder($scope.checkout).then(function (data) {
                ...
                if (data && data.result == "success" && data.redirect) {
                    PaymentmyfatoorahService.OpenPaymetWindow(data.redirect).then(function (data) {
